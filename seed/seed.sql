...
(1,'email','casual','You''re in, Jeffrey! Here''s what''s next','Hey Jeffrey!' || char(10) || '' || char(10) || 'Thanks for jumping on the call tonight — your VIP agreement is officially done. Here''s what''s coming:' || char(10) || '' || char(10) || '• Onboarding will reach out about staff setup' || char(10) || '• Your gear is getting ordered and shipped out' || char(10) || '• Any questions at all, just reach out' || char(10) || '' || char(10) || 'Excited to see your team rolling with this.' || char(10) || '' || char(10) || '— Gabriel','mock',NULL),
(1,'email','balanced','Your VIP agreement is complete','Jeffrey,' || char(10) || '' || char(10) || 'Good connecting tonight. Your VIP agreement is complete — here''s what happens next:' || char(10) || '' || char(10) || '1. Onboarding will reach out to schedule your staff setup' || char(10) || '2. Your gear order will be placed and shipped' || char(10) || '3. Any questions along the way, our team is one message away' || char(10) || '' || char(10) || 'Looking forward to getting your team up and running.' || char(10) || '' || char(10) || '— Gabriel','mock',NULL),
(1,'email','formal','Confirmation: Your VIP Agreement','Dear Jeffrey,' || char(10) || '' || char(10) || 'Thank you for your time this evening. This confirms your VIP agreement is complete. Next steps:' || char(10) || '' || char(10) || '1. Our onboarding team will contact you to schedule staff setup' || char(10) || '2. Your equipment order will be processed and shipped' || char(10) || '3. Please contact our team with any questions' || char(10) || '' || char(10) || 'Best regards,' || char(10) || 'Gabriel','mock',NULL),
...
(3,'email','casual','For your conversation with your husband','Priya,' || char(10) || '' || char(10) || 'Great talking today. Here''s the short version to share:' || char(10) || '' || char(10) || '• What it is and the timeline we discussed' || char(10) || '• The investment and payment options' || char(10) || '• The guarantee' || char(10) || '' || char(10) || 'If he has questions, I''m glad to hop on a quick call with you both.' || char(10) || '' || char(10) || 'What day this week works to reconnect?' || char(10) || '' || char(10) || '— Gabriel','mock',NULL),
