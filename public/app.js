...
const INTEGRATION_META = {
  // No SVG exists publicly for GoHighLevel: not in Simple Icons, no favicon.svg on any of their
  // subdomains, and their only favicon.ico is a single 16x16 that would be a blurred smear at
  // 34px. A clean monogram beats a bad upscale, so this one stays a monogram until someone can
  // get the real file from them.
  ...
  // Fathom's own mark, from fathom.video's asset CDN (logotype-new.svg), width/height stripped
  // so CSS sizes it.
  //
  // > [!warning] NOT the "Fathom" in Simple Icons. That one sources from usefathom.com — Fathom
  // > ANALYTICS, an unrelated privacy-analytics company. Shipping it here would have put a
  // > stranger's logo on the recorder we actually integrate with, which is exactly the failure
  // > a monogram was avoiding. Check the source URL, not the name.
  fathom: { label: "Fathom", blurb: "Imports call recordings and transcripts.", method: "token",
            tint: "#00BEFF", multi: true,
            icon: `<svg viewBox="0 0 151 153" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.921341 102.282V133.75C0.921341 142.004 6.05756 149.478 13.7776 151.959C26.8963 156.161 38.9436 146.302 38.9436 133.578V121.731L0.921341 102.282Z" fill="#007299"/><path d="M131.888 95.7704C129.031 95.7704 126.132 95.1181 123.402 93.7281L11.8239 36.9625C2.58091 32.2579 -1.71496 20.9347 2.59143 11.3757C7.08689 1.36768 18.7877 -2.78095 28.3773 2.09476L139.934 58.8497C149.292 63.6078 153.578 75.5298 148.893 85.0566C145.564 91.8463 138.852 95.7704 131.867 95.7704H131.888Z" fill="#00BEFF"/><path d="M75.8841 124.447C73.0272 124.447 70.1283 123.795 67.3974 122.405L11.8239 94.1344C2.58091 89.4298 -1.71496 78.1066 2.59143 68.5477C7.08689 58.5396 18.7877 54.391 28.3878 59.2667L83.9403 87.5266C93.2988 92.2847 97.5841 104.207 92.8996 113.733C89.57 120.523 82.8584 124.447 75.8736 124.447H75.8841Z" fill="#00BEFF"/></svg>`,
            where: ["In Fathom, go to Settings → Integrations → API Access.",
                    "Generate a key and copy it. No developer account needed."] },
  // Claude's mark from Simple Icons (CC0), whose record sources it from claude.ai. Single
  // monochrome path, painted in Anthropic's own #D97757.
  anthropic: { label: "Claude", blurb: "Writes the debrief, the drafts and the CRM note.",
               method: "key", tint: "#D97757", multi: false,
               icon: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path fill="#D97757" d="m4.7144 15.9555 4.7174-2.6471.079-.2307-.079-.1275h-.2307l-.7893-.0486-2.6956-.0729-2.3375-.0971-2.2646-.1214-.5707-.1215-.5343-.7042.0546-.3522.4797-.3218.686.0608 1.5179.1032 2.2767.1578 1.6514.0972 2.4468.255h.3886l.0546-.1579-.1336-.0971-.1032-.0972L6.973 9.8356l-2.55-1.6879-1.3356-.9714-.7225-.4918-.3643-.4614-.1578-1.0078.6557-.7225.8803.0607.2246.0607.8925.686 1.9064 1.4754 2.4893 1.8336.3643.3035.1457-.1032.0182-.0728-.164-.2733-1.3539-2.4467-1.445-2.4893-.6435-1.032-.17-.6194c-.0607-.255-.1032-.4674-.1032-.7285L6.287.1335 6.6997 0l.9957.1336.419.3642.6192 1.4147 1.0018 2.2282 1.5543 3.0296.4553.8985.2429.8318.091.255h.1579v-.1457l.1275-1.706.2368-2.0947.2307-2.6957.0789-.7589.3764-.9107.7468-.4918.5828.2793.4797.686-.0668.4433-.2853 1.8517-.5586 2.9021-.3643 1.9429h.2125l.2429-.2429.9835-1.3053 1.6514-2.0643.7286-.8196.85-.9046.5464-.4311h1.0321l.759 1.1293-.34 1.1657-1.0625 1.3478-.8804 1.1414-1.2628 1.7-.7893 1.36.0729.1093.1882-.0183 2.8535-.607 1.5421-.2794 1.8396-.3157.8318.3886.091.3946-.3278.8075-1.967.4857-2.3072.4614-3.4364.8136-.0425.0304.0486.0607 1.5482.1457.6618.0364h1.621l3.0175.2247.7892.522.4736.6376-.079.4857-1.2142.6193-1.6393-.3886-3.825-.9107-1.3113-.3279h-.1822v.1093l1.0929 1.0686 2.0035 1.8092 2.5075 2.3314.1275.5768-.3218.4554-.34-.0486-2.2039-1.6575-.85-.7468-1.9246-1.621h-.1275v.17l.4432.6496 2.3436 3.5214.1214 1.0807-.17.3521-.6071.2125-.6679-.1214-1.3721-1.9246L14.38 17.959l-1.1414-1.9428-.1397.079-.674 7.2552-.3156.3703-.7286.2793-.6071-.4614-.3218-.7468.3218-1.4753.3886-1.9246.3157-1.53.2853-1.9004.17-.6314-.0121-.0425-.1397.0182-1.4328 1.9672-2.1796 2.9446-1.7243 1.8456-.4128.164-.7164-.3704.0667-.6618.4008-.5889 2.386-3.0357 1.4389-1.882.929-1.0868-.0062-.1579h-.0546l-6.3385 4.1164-1.1293.1457-.4857-.4554.0608-.7467.2307-.2429 1.9064-1.3114Z"/></svg>`,
  ...
  // OpenAI was removed from Simple Icons and openai.com returns 403 to a plain fetch, so there
  // is no accurate mark to embed. Monogram until someone supplies the file.
...
//
// Two modes, because a real logo and a letter need opposite backgrounds. A brand mark carries its
// own colours and has to sit on a NEUTRAL tile — Fathom's cyan on a coral square would be a
// clash, and every reference that shows real logos (Charma, Chatbase, StackAI) puts them on a
// plain surface. A monogram is the reverse: it needs the tint to be legible in white.
const igMark = (m, size = 28) => m.icon
  ? `<span class="ig-mark ig-mark-logo" style="width:${size}px;height:${size}px">${m.icon}</span>`
